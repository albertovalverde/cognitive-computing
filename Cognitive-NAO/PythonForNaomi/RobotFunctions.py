...
class Robot:
    def __init__(self, IP, PORT, config, robotCheck):
        ...
        self.robotFunctionsDict["play-game-choose-color"] = Robot.__dict__[
            "PlayGameChooseColor"]  # Set the custom visual recognition command to take a picture
